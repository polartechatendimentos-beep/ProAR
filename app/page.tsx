...
function HousesWorkModule({ companyId, company, responsibleUser = "Utilizador do ProAR" }: { companyId: string; company: TenantCompany; responsibleUser?: string }) {
  ...
  return <section className="houses-app">
    ...
    <WorkOperationsPanel workId={activeProject.id} units={houses} responsibleUser={responsibleUser}/>
...
export default function Home() {
  ...
  return <div className="app-shell">
    ...
    <main className="main">
      ...
      <footer><span>© 2026 ProAR Gestão de Serviços • {APP_VERSION}</span><span><ShieldCheck size={12}/> Gestão segura e inteligente para prestadores de serviços.</span></footer>
    </main>
