...
export async function PUT(request: NextRequest) {
  ...
  const payload = { companyId, token, title: String(body.title || "Acompanhamento da obra — 142 Casas"), houses: Array.isArray(body.houses) ? body.houses : [], updatedAt: new Date().toISOString() };
